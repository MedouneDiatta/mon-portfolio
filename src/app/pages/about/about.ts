  ...
  template: `
    <div class="container py-5">
      ...
      <div class="text-center mb-5">
        ...
        <p class="text-muted">
          Nous sommes <strong>Abdourahmane Diouf</strong> et <strong>Médoune Diatta</strong>, deux étudiants passionnés 
      ...
      <div class="row g-4 mb-5">
        ...
        <div class="col-md-6">
          <div class="card h-100 shadow-sm border-primary">
            <div class="card-header bg-primary text-white">
              <h3 class="h5 mb-0">Abdourahmane Diouf</h3>
            </div>
            <div class="card-body">
              <p>Étudiant en <strong>Licence 1 Informatique</strong>, je m'intéresse particulièrement au développement web et à la conception d'interfaces modernes.</p>
              
              <h6 class="text-primary mt-4"> Mes tâches dans ce projet :</h6>
              ...
              <h6 class="text-primary mt-3"> Compétences :</h6>
              <div class="d-flex flex-wrap gap-2">
                ...
                <span class="badge bg-dark">Git & GitHub</span>
                <span class="badge bg-secondary">Langage C</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card h-100 shadow-sm border-primary">
            <div class="card-header bg-primary text-white">
              <h3 class="h5 mb-0">Médoune Diatta</h3>
            </div>
            <div class="card-body">
              <p>Étudiant en <strong>Licence 1 Informatique</strong>, je m'intéresse au développement web ainsi qu'à la programmation en général.</p>
        ...
        <div class="col-12">
          <div class="card shadow-sm bg-light border-0">
            <div class="card-body p-4 p-md-5">
              <h4 class="text-primary mb-3"> Notre travail en équipe</h4>
              <p>
              ...
              <h4 class="text-primary mb-3 mt-4"> Notre objectif</h4>
              <p>
